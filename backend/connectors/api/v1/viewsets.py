...
class Testconnectors133541ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS133541_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS133541_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS133541"
